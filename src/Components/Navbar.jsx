  ...
  return (
    <div className='navbar' id='nav_bar'>
      ...
      <div className="nav-connect">
        <a href="https://github.com/Abhishek172004" target='_blank'>
          <img src={git_log} alt="" />
        </a>
        <a href="https://www.linkedin.com/in/abhishek-kumar-iit-bhu-ece/"  target='_blank'>
          <img src={linked_log} alt="" />
        </a>
        <a href="https://www.instagram.com/abhishek_____1702/" target='_blank'>
